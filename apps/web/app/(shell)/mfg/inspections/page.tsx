...
export default function InspectionsPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      <Breadcrumb items={[{ label: "Home", href: "/mfg/home" }, { label: "Inspections" }]} />
      <CommandBar actions={[
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {!loading && inspections.length === 0 && (
                <tr><td colSpan={6} className="px-4 py-8 text-center text-sm text-ink-3">No inspections found.</td></tr>
              )}
            </tbody>
          </table>
        )}
