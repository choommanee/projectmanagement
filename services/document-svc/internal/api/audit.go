...
// auditWrite records a successful document-management mutation in the
// PLATFORM audit_log. This is separate from (and additive to) the signing
// subsystem's hash-chained sign_event trail — see auditMeta/service.AuditMeta
// for that. Best-effort: never blocks or fails the request.
